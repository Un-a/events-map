...
Мероприятие добавлено в список дня: ${day === 'saturday' ? 'суббота' : 'воскресенье'}${date ? ` (${date})` : ''}.
Если в тексте есть явное деление по дням или датам (через дату, "суббота"/"воскресенье", или 📍 с датой) —
верни только места для указанного дня или даты.
...
ВАЖНО: если в тексте есть описание места (например "большая площадь в Земуне") — попробуй определить официальное название этого места.
